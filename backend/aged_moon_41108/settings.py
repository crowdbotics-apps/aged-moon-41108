"""
Django settings for aged_moon_41108 project.
...
ROOT_URLCONF = 'aged_moon_41108.urls'
...
WSGI_APPLICATION = 'aged_moon_41108.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "aged_moon_41108 API",
    "DESCRIPTION": "API documentation for aged_moon_41108 App",
    "VERSION": "v1",
}
